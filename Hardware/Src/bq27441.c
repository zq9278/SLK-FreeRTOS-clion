...
uint8_t NEW_TR_MSB=0x01,NEW_TR_LSB=0xA5;//2700mAh/(0.1*64mA)��64mAΪBQ25895���ضϵ���
...
{ 
	...
	while(hi2c1.State != HAL_I2C_STATE_READY){;}
	if(OLD_DC_MSB != NEW_DC_MSB || OLD_DC_LSB != NEW_DC_LSB)//��ȡ����������ݣ����趨һ���Ͳ��������趨
	{	
		...
		if(CHKSUM==NEW_CHKSUM)
		{
			...
			AT24CXX_WriteOneByte(EEPROM_BQ27441Config_Add,0x55);//������ɺ�д��EEPROM
			return 1;
		}
		else
		{
